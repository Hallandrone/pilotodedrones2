...
serve(async (req) => {
	...
	try {
		...
		if (isNewUser) {
			emailSubject = '¡Bienvenido! Has sido invitado como Administrador';
			emailHtml = `
      <!DOCTYPE html>
      <html>
      <body style="font-family: Arial, sans-serif; color: #333; line-height: 1.6;">
        ...
        <div style="padding: 30px; border: 1px solid #edf2f7; border-top: 0; border-radius: 0 0 8px 8px;">
          ...
          <div style="background: #f8fafc; padding: 20px; border-radius: 12px; margin: 25px 0; border: 1px solid #e2e8f0;">
            <p style="margin: 0 0 10px; color: #4a5568;">Aquí tienes tus credenciales de acceso:</p>
          ...
          <div style="margin: 30px 0; text-align: center;">
            <a href="${FRONTEND_URL}/auth" style="background-color: #00b3f3; color: white; padding: 14px 28px; text-decoration: none; border-radius: 8px; font-weight: bold; display: inline-block; box-shadow: 0 4px 6px rgba(0,179,243,0.2);">Acceder al Panel</a>
          </div>

          <div style="border-top: 1px solid #edf2f7; pt: 20px; margin-top: 30px;">
            <p style="font-size: 0.9em; color: #718096;">Tu cuenta ha sido pre-configurada con los siguientes accesos:</p>
            <ul style="color: #4a5568; font-size: 0.9em;">
      ...
      <body style="font-family: Arial, sans-serif; color: #333; line-height: 1.6;">
        ...
        <div style="padding: 30px; border: 1px solid #edf2f7; border-top: 0; border-radius: 0 0 8px 8px;">
          ...
          <div style="background: #e6f7ff; padding: 20px; border-radius: 12px; margin: 25px 0; border-left: 4px solid #00b3f3;">
            <p style="margin: 0 0 10px; font-weight: bold;">Tus nuevos permisos asignados:</p>
            <ul style="margin: 0; padding-left: 20px;">
              ${permissions.map((p: string) => `<li style="text-transform: capitalize;">${p.replace(/_/g, ' ')}</li>`).join('')}
            </ul>
          </div>

          <p>Puedes acceder a estas funcionalidades directamente desde tu panel de administración.</p>
          
          <div style="margin: 30px 0; text-align: center;">
            <a href="${FRONTEND_URL}/dashboard" style="background-color: #00b3f3; color: white; padding: 14px 28px; text-decoration: none; border-radius: 8px; font-weight: bold; display: inline-block; box-shadow: 0 4px 6px rgba(0,179,243,0.2);">Ir al Dashboard Profesional</a>
          </div>
        </div>
      </body>
      </html>
