-- ============================================
-- FIX CERTIFICATIONS STORAGE POLICIES
-- Use this to ensure correct policies exist
-- ============================================

-- First, drop ALL existing storage policies for certifications bucket
-- Drop by specific policy names
...
-- Create fresh policies using storage.foldername (matches migration)
...
-- List all storage policies for certifications
SELECT policyname 
FROM pg_policies 
